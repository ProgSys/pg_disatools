	...
	ui(new Ui::SpriteSheetEditorWindow)
{
	...
	setWindowTitle(TITLE_SpriteSheetEditor);

	ui->btnPrevious->setIcon(QIcon(getResourcePath()+"/materials/icons/previous.png"));
	ui->btnPausePlay->setIcon(QIcon(getResourcePath() + "/materials/icons/pause.png"));
	ui->btnNext->setIcon(QIcon(getResourcePath() + "/materials/icons/next.png"));
	...
	connect(ui->action_resize, &QAction::triggered, m_player->getSpriteData(), &SpriteData::spriteSheetResize);
	connect(ui->actionBatch_resize, &QAction::triggered, m_player->getSpriteData(), &SpriteData::batchDoubleResize);
    ...
    ui->quickSpriteView->setSource(QUrl::fromLocalFile(getResourcePath() + "/QML/SpriteView.qml"));
    ...
    ui->quickColorTable->setSource(QUrl::fromLocalFile(getResourcePath() + "/QML/ColorTableView.qml"));
...
void SpriteSheetEditor::setTitel(const QString& filename){
	 ...
	 QString title(TITLE_SpriteSheetEditor);
	 title.append(" - ");
...
void SpriteSheetEditor::setImagePlay(){
	ui->btnPausePlay->setIcon(QIcon(getResourcePath() + "/materials/icons/play.png"));
}
