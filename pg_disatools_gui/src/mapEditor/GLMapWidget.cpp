...
void GLMapWidget::initializeGL(){
    ...
    m_objectShader.addShaderFile(PG::GL::Shader::VERTEX, "resources/shaders/tile.vert");
    m_objectShader.addShaderFile(PG::GL::Shader::FRAGMENT, "resources/shaders/tile.frag");
    ...
    //load texture
    {
		...
		PG::FILE::loadTGA("resources/materials/test_texture.tga", img);
		m_tileTex.bind(img);
    }
    //load geometry
